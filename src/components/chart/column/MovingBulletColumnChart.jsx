...
export default function MovingBulletColumnChart() {
  ...
  useLayoutEffect(() => {
    ...
    // series 관련 수치 값
    const seriesMaxWidth = 50;
    const maxRadius = seriesMaxWidth * 0.65;
    const size = (chart.width() / data.length) * 0.4;
    ...
    series.bullets.push((root, cols, dataItem) => {
      ...
      bulletContainer.children.push(
        am5.Circle.new(root, { layer: 99, radius: radius, fill: colorList[index] })
      );
...
// codeblock
export const MovingBulletColumnCodeblock = `import * as am5 from "@amcharts/amcharts5";
import * as am5xy from "@amcharts/amcharts5/xy";
import am5themes_Animated from "@amcharts/amcharts5/themes/Animated";
import { useLayoutEffect } from "react";
import * as themes from "@/assets/chartTheme";
