...
export default function TwoLevelPieChart() {
  ...
  useLayoutEffect(() => {
    ...
    series0.slices.template.setAll({
      ...
      shadowBlur: 4,
      shadowColor: am5.color(themes.chartVariables[theme].base),
    });
    ...
    series1.labels.template.setAll({ textType: "circular" });
...
// codeblock 
export const TwoLevelPieCodeblock = `import * as am5 from "@amcharts/amcharts5";
import * as am5percent from "@amcharts/amcharts5/percent";
import am5themes_Animated from "@amcharts/amcharts5/themes/Animated";
import { useLayoutEffect } from "react";
import * as themes from "@/assets/chartTheme";
