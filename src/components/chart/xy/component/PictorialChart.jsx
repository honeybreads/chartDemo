...
const data = [
  {
    ...
    height: 828,
    ratio: 1 / 5.12,
    pictureSettings: { src: icon1 },
  },
  {
    category: "Willis Tower",
    height: 527,
    ratio: 1 / 5.06,
    pictureSettings: { src: icon2 },
  },
  {
    category: "Taipei 101",
    height: 508,
    ratio: 1 / 6.73,
    pictureSettings: { src: icon3 },
  },
  {
    category: "Petronas Towers",
    height: 452,
    ratio: 1 / 2.76,
    pictureSettings: { src: icon4 },
  },
  {
    category: "Empire State Building",
    height: 449,
    ratio: 1 / 3.41,
    pictureSettings: { src: icon5 },
  },
];
...
export default function PictorialChart() {
  ...
  useLayoutEffect(() => {
    ...
    yAxis.get("renderer").grid.template.setAll({ strokeDasharray: [4, 4] });
